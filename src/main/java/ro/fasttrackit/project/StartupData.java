...
public class StartupData implements CommandLineRunner {
	...
	public StartupData(MovieRepository movieRepository) {
		this.movieRepository = movieRepository;
	}

	@Override
	public void run(String... args) {
		Movie movie1 = movieRepository.save(new Movie("Dune", 2021, "Feature adaptation of Frank Herbert's science fiction novel, about the son of a noble family entrusted with the protection of the most valuable asset and most vital element in the galaxy.", 9.6, postersMovie1(), trailersMovie1()));
		Movie movie2 = movieRepository.save(new Movie("Foundation", 2021, "A complex saga of humans scattered on planets throughout the galaxy all living under the rule of the Galactic Empire.", 8.5, postersMovie2(), trailersMovie2()));
		Movie movie3 = movieRepository.save(new Movie("The Matrix", 1999, "When a beautiful stranger leads computer hacker Neo to a forbidding underworld, he discovers the shocking truth--the life he knows is the elaborate deception of an evil cyber-intelligence.", 8.7, postersMovie3(), trailersMovie3()));
		Movie movie4 = movieRepository.save(new Movie("The Witcher", 2019, "Geralt of Rivia, a solitary monster hunter, struggles to find his place in a world where people often prove more wicked than beasts.", 8.2, postersMovie4(), trailersMovie4()));
		Movie movie5 = movieRepository.save(new Movie("Star Trek: Discovery", 2017, "Ten years before Kirk, Spock, and the Enterprise, the USS Discovery discovers new worlds and lifeforms as one Starfleet officer learns to understand all things alien.", 7.2, postersMovie5(), trailersMovie5()));
		Movie movie6 = movieRepository.save(new Movie("The Lord of the Rings: The Two Towers", 2002, "While Frodo and Sam edge closer to Mordor with the help of the shifty Gollum, the divided fellowship makes a stand against Sauron's new ally, Saruman, and his hordes of Isengard.", 8.7, postersMovie6(), trailersMovie6()));
		Movie movie7 = movieRepository.save(new Movie("The Dark Knight", 2008, "When the menace known as the Joker wreaks havoc and chaos on the people of Gotham, Batman must accept one of the greatest psychological and physical tests of his ability to fight injustice.", 9.0, postersMovie7(), trailersMovie7()));
		Movie movie8 = movieRepository.save(new Movie("Westworld", 2016, "Set at the intersection of the near future and the reimagined past, explore a world in which every human appetite can be indulged without consequence.", 8.6, postersMovie8(), trailersMovie8()));
		Movie movie9 = movieRepository.save(new Movie("Interstellar", 2014, "A team of explorers travel through a wormhole in space in an attempt to ensure humanity's survival.", 8.6, postersMovie9(), trailersMovie9()));
		Movie movie10 = movieRepository.save(new Movie("Blade Runner 2049", 2017, "Young Blade Runner K's discovery of a long-buried secret leads him to track down former Blade Runner Rick Deckard, who's been missing for thirty years.", 8.0, postersMovie10(), trailersMovie10()));
	}
